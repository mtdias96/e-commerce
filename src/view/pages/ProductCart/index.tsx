...
//   const { productCart } = useProductCartController()

//   return (
//     <>
//       <Menu />
//       <section className="pt-48 w-full h-full bg-gray-50">
...
//                   <span className='text-right text-xl font-medium'>R$ 566,00</span>
//                 </div>

//                 <div className='flex items-center justify-between '>
//                   <p className='text-xl text-black/60'>Desconto (-24%)</p>
//                   <span className='text-right text-xl font-medium text-red-700'>R$ 113,00</span>
//                 </div>
...
//                   <span className='text-2xl font-medium'>R$ 467</span>
//                 </div>
          ...
          <div className='flex flex-col md:flex-row w-full justify-center gap-6 mt-8'>
            ...
            <div className='flex flex-col justify-start bg-white shadow-md rounded-lg p-4 md:p-6 mb-4 w-full md:w-[400px] md:h-[420px]'>
              ...
              <div className='w-full flex flex-col gap-4'>
                <div className='flex justify-between mt-4'>
                  <p className='text-xl'>Total</p>
                  <span className='text-2xl font-medium'>R$ {discountedValue}</span>
                </div>
                <div className='flex justify-between gap-2 '>
                  <div className="flex items-center gap-3 bg-gray-200 max-xl:hidden px-2.5 rounded-xl">
                    <IoTicketOutline className="w-6 h-6 text-gray-500 cursor-pointer hover:opacity-75 transition-all" />
