...
import { CardCart } from "../../components/Menu/ToggleCartMenu/components/CardCart";
      ...
      <section className="pt-48 w-full bg-gray-50 min-h-screen">
        ...
        {productCart.length > 0 && (
          <div className="flex flex-col md:flex-row w-full justify-center gap-6 mt-8">
            <div
              className={`bg-white shadow-md rounded-lg p-4 md:p-6 mb-4 flex flex-col overflow-y-auto md:h-[420px] ${
                productCart.length > 3
                  ? "md:grid-cols-3"
                  : "md:grid-cols" + productCart.length
              }`}
            >
            ...
            <div className="flex flex-col justify-start bg-white shadow-md rounded-lg p-4 md:p-6 mb-4 w-full md:w-[400px] md:h-[420px]">
              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-center justify-between ">
                  ...
                  <span className="text-right text-xl font-medium">
                    {formatCurrency(priceProducts)}
                  </span>
                </div>

                <div className="flex items-center justify-between ">
                  <p className="text-xl text-black/60">Desconto</p>
                  <span className="text-right text-xl font-medium text-red-700">
                    R$ 00,00
                  </span>
                </div>
              ...
              <div className="w-full flex flex-col gap-4">
                ...
                <Button className="w-full bg-red-500 hover:opacity-80 ">
                  COMPRAR
                </Button>
              </div>
            </div>
