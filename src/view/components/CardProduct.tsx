  ...
  return (
    <div className='border rounded-md border-blue-50 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 mb-8 transform transition-transform duration-300 hover:-translate-y-2'>
      <div className="relative w-full  overflow-hidden group">
        <img className="max-w-full object-cover" src={nike1} alt="tenis nike" />
      ...
      <Link to="/shop/product/:productId" className='mt-3 flex flex-col justify-center items-center gap-2 pb-4 max-w-full'>
        ...
        <p className='flex gap-4 items-center justify-center'>
          <span className='text-blue-400 font-bold left-8 tracking-wider max-w-full'>R$ 888,00</span>
